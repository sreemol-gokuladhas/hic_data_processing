...
tmp_dir="/scale_wlg_persistent/filesets/project/uoa02869/colon_cancer_hic/scripts"
...
do
    ...
    parallel-fastq-dump --sra-id $line --threads 32 --tmpdir $tmp_dir --outdir $out_dir --split-files --gzip
    echo $line "done."
done
